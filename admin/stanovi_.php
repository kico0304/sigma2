                    ...
                    <div class="page-wrapper">
                        ...
                        <div class="container-fluid">
                            <div class="row" style="margin-bottom: 25px;">
                                <div class="col-lg-12">
                                    <a href="dodajstan.php">
                                        <button type="button" class="btn btn-success btn-sm text-white dodajLokaciju"><i class="mdi mdi-plus"></i> Dodaj stan</button>
                                    </a>
                                </div>
                            </div>
                        <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row"><?php echo $stan['id_lokacije_'] ?></th>
                                <th scope="row"><?php echo $stan['naziv_lokacije_'] ?></th>
                                <td><?php echo $stan['id_sprata_'] ?></td>
                                <td><?php echo $stan['naziv_sprata_'] ?></td>
                                <td><?php echo $stan['stan_id_'] ?></td>
                                <td><?php echo $stan['stan_naziv_'] ?></td>
                                <td><?php echo $stan['stan_brojprostorija_'] ?></td>
                                <td><?php echo $stan['stan_kvadratura_'] ?></td>
                                <td><?php echo $stan['stan_tlocrt_'] ?></td>
                                <td><?php echo $stan['stan_pozicija_'] ?></td>
                                <td>
                                    <?php 
